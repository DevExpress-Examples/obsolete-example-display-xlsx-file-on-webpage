...
Partial Public Class UserControls_WorkbookPreviewControl
	...
	Private privateWorkbook As IWorkbook
	Public Property Workbook() As IWorkbook
		Get
			Return privateWorkbook
		End Get
		Set(ByVal value As IWorkbook)
			privateWorkbook = value
		End Set
	End Property
	Private privateClientInstanceName As String
	Public Property ClientInstanceName() As String
		Get
			Return privateClientInstanceName
		End Get
		Set(ByVal value As String)
			privateClientInstanceName = value
		End Set
	End Property
	Private privateShowOnlyFirstWorksheet As Boolean
	Public Property ShowOnlyFirstWorksheet() As Boolean
		Get
			Return privateShowOnlyFirstWorksheet
		End Get
		Set(ByVal value As Boolean)
			privateShowOnlyFirstWorksheet = value
		End Set
	End Property
	...
	Private Sub PrepareIframeProperties(ByVal i As Integer, ByVal iframe As HtmlGenericControl)
		...
		iframe.Attributes.Add("height", "500px")
